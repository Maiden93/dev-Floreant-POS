...
public class PrintConfigurationView extends ConfigurationView {
	...
	private JCheckBox chkKitchenBtn = new JCheckBox(Messages.getString("PrintConfigurationView.2"));
	...
	private void initComponents() {
		...
		MultiPrinterPane multiPrinterPane = new MultiPrinterPane(Messages.getString("PrintConfigurationView.3"), printers.getKitchenPrinters()); //$NON-NLS-1$
