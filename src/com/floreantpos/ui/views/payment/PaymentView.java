...
public class PaymentView extends JPanel {
	...
	private void initComponents() {
		...
		btnAmount1.setActionCommand("500"); //$NON-NLS-1$
		...
		btnAmount2.setActionCommand("1000"); //$NON-NLS-1$
		...
		btnAmount5.setActionCommand("2000"); //$NON-NLS-1$
		...
		btnAmount10.setActionCommand("5000"); //$NON-NLS-1$
		...
		btnAmount20.setText("10000"); //$NON-NLS-1$
		btnAmount20.setActionCommand("10000"); //$NON-NLS-1$
		...
		btnAmount50.setText("20000"); //$NON-NLS-1$
		btnAmount50.setActionCommand("20000"); //$NON-NLS-1$
		...
		btnAmount100.setText("50000"); //$NON-NLS-1$
		btnAmount100.setActionCommand("50000"); //$NON-NLS-1$
		...
		btnClear.setText(Messages.getString("PaymentView.66")); //$NON-NLS-1$
		...
		btnOther = new PosButton(POSConstants.OTHERS_PAYMENT); //$NON-NLS-1$
