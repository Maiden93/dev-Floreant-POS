...
public class AuthorizableTicketBrowser extends POSDialog {
	...
	private void init() {
		...
		buttonPanel.add(new PosButton(ActionCommand.EDITAR_PROPINA, actionHandler), "grow");
		buttonPanel.add(new PosButton(ActionCommand.AUTORIZAR, actionHandler), "grow");
		buttonPanel.add(new PosButton(ActionCommand.AUTORIZAR_TODO, actionHandler), "grow");
		buttonPanel.add(new PosButton(ActionCommand.CANCELAR_TRANSACCION, actionHandler), "grow");
		...
		buttonPanel2.add(new PosButton(ActionCommand.CANCELAR_TRANSACCION, actionHandler), "grow");
		...
		tabbedPane.addTab("Autorizaciones en espera", authWaitingTab);
		tabbedPane.addTab("Autorizaciones cerradas", authClosedTab);
...
//		}
	...
	private void doVoidTransaction() {
		...
		int option = POSMessageDialog.showYesNoQuestionDialog(AuthorizableTicketBrowser.this, "La transacción seleccionada será anulada, proceder?", "Confirmar");
