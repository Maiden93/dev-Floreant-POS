...
public class ConfirmPayDialog extends POSDialog {
	...
	public void setAmount(double amount) {
		lblInfo.setText("<html>Vas a procesar <b>" + CurrencyUtil.getCurrencySymbol() + amount
							+ "</b>.<br/><br/>Si está seguro, presione <b>CONFIRMAR</b>, De lo contrario, presione <b>CANCELAR</b>.<br/><br/></html>");
	}
}
