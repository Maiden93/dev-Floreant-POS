...
public class POSConstants {
	...
	public static final String ENABLED = Messages.getString("Mensaje01"); //$NON-NLS-1$
	...
	public static final String BUMP = Messages.getString("MensajeCocina.01"); //$NON-NLS-1$
	...
	public static final String MAX_NUM_MODIFIER = Messages.getString("MAX_NUM_MOFIFIER"); //$NON-NLS-1$
	public static final String MIN_NUM_MODIFIER = Messages.getString("MIN_NUM_MOFIFIER"); //$NON-NLS-1$
	public static final String MINI_NUM_MODIFIER = Messages.getString("MINI_NUM_MOFIFIER"); //$NON-NLS-1$
	public static final String SEND_ORDER_KITCHEN = Messages.getString("SEND_ORDER_KITCHEN"); //$NON-NLS-1$
	public static final String ENVIAR_ORDEN_COCINA = Messages.getString("ENVIAR_ORDEN_COCINA"); //$NON-NLS-1$
	public static final String INGRESAR_PASS = Messages.getString("INGRESAR_PASS"); //$NON-NLS-1$
	public static final String ERROR_PASS = Messages.getString("ERROR_PASS"); //$NON-NLS-1$
	public static final String OTHERS_PAYMENT = Messages.getString("OTHERS_PAYMENT"); //$NON-NLS-1$
	public static final String ENTER_COUPON_DISCOUNT = Messages.getString("ENTER_COUPON_DISCOUNT"); //$NON-NLS-1$
	public static final String FILTER_LABEL_KITCHEN = Messages.getString("FILTER_LABEL_KITCHEN"); //$NON-NLS-1$
	public static final String SELECT_FILTER_KITCHEN = Messages.getString("SELECT_FILTER_KITCHEN"); //$NON-NLS-1$
	
	public static final String TIQUETE_KITCHEN = Messages.getString("TIQUETE_KITCHEN"); //$NON-NLS-1$
	public static final String TABLE_KITCHEN = Messages.getString("TABLE_KITCHEN"); //$NON-NLS-1$
